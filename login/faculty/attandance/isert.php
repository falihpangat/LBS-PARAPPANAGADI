...
<label><input type="text" name="perc" placeholder="Percentage*"> </label><br><br>
 <label><input type="checkbox" name="attendance" value="eligible" id="ab">Eligible</label> 
<label><input type="checkbox" name="attendance" value="In eligiblet" id="ab">Not Eligible</label><br><br>
